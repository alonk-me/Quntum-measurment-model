...
.. math::
   ...
   M_0 = \frac{1}{\sqrt{1 + a^2}} \begin{pmatrix}a & 0\\0 & 1\end{pmatrix},
   \quad
   M_1 = \frac{1}{\sqrt{1 + a^2}} \begin{pmatrix}1 & 0\\0 & a\end{pmatrix},
